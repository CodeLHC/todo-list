...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   neededTask: () => (/* binding */ neededTask)\n/* harmony export */ });\nconst neededTask = (() => {\n  let task;\n\n  const getTask = () => {\n    return task;\n  };\n\n  const setTask = (newTask) => {\n    task = newTask;\n  };\n\n  return { getTask, setTask };\n})();\n\n\n\n\n//# sourceURL=webpack://todo-list/./src/neededTask.js?");
